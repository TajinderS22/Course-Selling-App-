      ...
      <div className="max-w-7xl mx-auto px-6 py-10 grid md:grid-cols-4 grid-cols-2 gap-8">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            ...
            <li><a href="/t" className="hover:underline">Contact</a></li>
        ...
        <div>
          ...
          <div className="flex space-x-4">
            <a href="http://github.com/TajinderS22"
              target="_blank" 
              rel="noopener noreferrer"
            
            >

              <svg fill="#000000" width="800px" height="800px" viewBox="0 0 24 24" className='h-6 w-6 dark:fill-amber-200/50' xmlns="http://www.w3.org/2000/svg">
