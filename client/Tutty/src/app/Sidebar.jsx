...
const Sidebar = () => {
  ...
  return (
    <div className={`fixed md:sticky md:h-[100svh] h-fit not-md:${open&&'w-[600px]'}   `}>
        <div className={` sticky top-0 pt-8 ${open&&"md:w-72"} text-black dark:text-white  transform-all ease-in-out not-md:rounded-r-xl   py-6 not-md:bg-transparent not-md:h-12   z-10   duration-300 md:dark:bg-slate-600 bg-slate-300 md:h-[100%] not-md:${open&& 'h-[600px] ' } not-md:flex not-md:flex-col ${open&&"not-md:w-[320px] not-md:bg-slate-600 " }
        not-md:${open&&'w-[300px]'}
         `
        }>
