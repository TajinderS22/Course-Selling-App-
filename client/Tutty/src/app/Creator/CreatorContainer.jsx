...
const CreatorContainer = () => {
  ...
  return (
    <div className="min-h-svh w-full bg-app pb-6 text-ink">
      ...
      <div className="mx-auto max-w-6xl pt-6 px-4 md:px-12">
        {/* Profile card */}
        <div className="card  flex flex-col items-center gap-5 p-6 md:flex-row md:gap-8">
          <img
        ...
        <div className="mt-8 pb-10">
          <p className="font-display text-2xl font-bold">Your courses</p>
