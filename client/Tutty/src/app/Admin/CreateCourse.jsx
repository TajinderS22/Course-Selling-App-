...
const CreateCourse = () => {
  ...
  return (
    <div>
        <Navbar/>
        <div className='h-fit min-h-[96svh] bg-[#ADEED9]/40 '>
                    ...
                    <div className='flex flex-col items-center'>
                        ...
                        <div className='flex flex-col mx-2'>
                            <div className='min-w-[300px] flex justify-between flex-col md:block '>
                                ...
                                <input ref={titleRef} type="text" name='title' placeholder='title' className='bg-blue-400/30 p-2 m-2 md:w-[80%] rounded-2xl' />
                            </div>
                            <div className='min-w-[300px] flex justify-between  flex-col md:block '>
                                <label htmlFor="discription">Discription : </label>
                                <input ref={discriptionRef} type="text" name='discription' placeholder='discription' className='bg-blue-400/30 p-2 m-2  md:w-[66%] rounded-2xl' />
                            </div>
                        </div>
                        <div className='flex flex-col mx-2'>
                        <div className='min-w-[300px] flex justify-between flex-col md:block '>
                                <label htmlFor="price">Price : </label>
                                <input ref={priceRef} type="text" name='price' placeholder='price' className='bg-blue-400/30 p-2 m-2 md:w-[78%]  rounded-2xl' />
                            </div>
                            <div className='min-w-[300px] flex justify-between flex-col md:block '>
                                <label htmlFor="imgUrl">ImageUrl : </label>
                                <input ref={imageUrlRef} type="text" name='imgUrl' placeholder='imgUrl' className='bg-blue-400/30 p-2 m-2 md:w-[70%]  rounded-2xl' />
                            </div>
                        </div>
                        </div>
                        <button
